    ...
    public static void checkTCon2()
    {
        ...
        if (Loader.isModLoaded("tconstruct"))
        {
            ...
            if (Loader.isModLoaded("foundry")) {
                ...
                TinkerRegistry.registerMelting(new ItemStack(Item.REGISTRY.getObject(new ResourceLocation("enderio:itemAlloy")),1,6), FluidRegistry.getFluid("liquiddarksteel"), 144);
                ...
                //Enderium
                TinkerRegistry.registerAlloy(new FluidStack(FluidRegistry.getFluid("liquidenderium"), 9), new FluidStack(FluidRegistry.getFluid("liquidplatinum"), 3), new FluidStack(FluidRegistry.getFluid("silver"), 3), new FluidStack(FluidRegistry.getFluid("liquidenderpearl"), 12), new FluidStack(FluidRegistry.getFluid("tin"), 6));
