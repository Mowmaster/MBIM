...
public class compressedgranite extends Block
{
    ...
    public static final PropertyEnum<compressedgranite.EnumType> VARIANT = PropertyEnum.<compressedgranite.EnumType> create("variant", compressedgranite.EnumType.class);

    public compressedgranite() {

        super(Material.SAND);
        this.setUnlocalizedName("compressed_andesite");
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, compressedgranite.EnumType.COMPRESSED));
    ...
    public IBlockState getStateFromMeta (int meta) {
        ...
        return this.getDefaultState().withProperty(VARIANT, compressedgranite.EnumType.byMetadata(meta));
    }
    ...
    public enum EnumType implements IStringSerializable {
        ...
        private static final compressedgranite.EnumType[] META_LOOKUP = new compressedgranite.EnumType[values().length];
        ...
        public static compressedgranite.EnumType byMetadata (int meta) {
        ...
        static {
            ...
            for (final compressedgranite.EnumType type : values())
